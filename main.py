...
map = {
  'Mercado': ['MERCADO', 'FORTIS', 'SUPERSEIS', 'BOX', 'STOCK', 'LA MODERNA', 'SUPERMERCADO', 'LA HUERTA', 'ATACADAO'],
  'Alimentação': ['ALMOÇO','ALMOCO' ,'ALMUERZO', 'JANTA', 'JANTAR', 'CENA', 'DESAYUNO', 'CAFE', 'CAFETERIA', 'CAFE DA MANHA', 'LANCHE', 'SALGADO',
                  ...
                  'ARENA', 'TERRAZA', 'PANADERIA', 'PADARIA', 'BOLERIA', 'CHIPERIA', 'HELADO', 'SORVETE', 'PICOLE', 'TORTA', 'BOLO',
                  'CHOCOLATE', 'BOMBOM', 'AGUA', 'COCA', 'BEBIDA', 'MILKSHAKE', 'ALIMENTACAO', 'CALDOS E CIA', 'CALDAS E CIA', 'GORJETA'],
  'Casa':  ['DIARISTA', 'LUZ', 'AGUA', 'CASA', 'PROSEGUR', 'ALUGUEL',
            'TIGO', 'CLARO', 'BASURA', 'ANDE', 'PERSONAL', 'ESSAP', 'ALQUILER', 'CASA', 'RECARGA'],
  'Transporte': ['ESTACIONAMENTO', 'ESTACIONAMIENTO', 'GASOLINA', 'BOLT', 'PEDAGIOS', 'TROCA DE ACEITE', 'UBER', 'LAVAJATO', 'LAVA JATO', 'PEAJE', 'AURIS', 'TROCA DE OLEO', 'TRANSPORTE'],
  'Saúde': ['REMEDIO', 'HOSPITAL', 'FARMACIA', 'SAUDE', 'EXAME', 'FISIOTERAPIA', 'VACINA', 'DRENAGEM LINFATICA'],
  ...
  'Educação': ['ITALKI', 'CURSO', 'COURSERA', 'LIVRO', 'CERTIFICACAO', 'UDEMY', 'EDUCACAO', 'FACULDADE', 'PUC'],
  'Tecnologia': ['TECNOLOGIA'],
  'Lazer': ['KART', 'HOSPEDAGEM', 'AIRBNB', 'CORRIDA', 'LAZER', 'TIRO', 'MUNICAO', 'CINEMA', 'CINEMARK'],
  'Roupas': ['NIKE', 'ZARA', 'ROUPA', 'SAPATO', 'TENIS', 'ROUPAS', 'BRINCOS'],
  'Presentes': ['PRESENTE', 'FLORES', 'LEMBRANCA', 'SURPRESA'],
  'Doações': ['DOACAO'],
  'Investimentos': ['BITCOIN'],
  'Taxas': ['TAXA', 'COMISSAO', 'TARIFA', 'TAXAS'],
  'Impostos': ['IMPOSTO', 'SAQUE', 'IMPOSTOS', 'CONTADOR', 'CONTADORA'],
  'Bebê': ['MURILO', 'NENEM', 'GESTACAO', 'DOULA', 'AMAMENTACAO', 'BERCO', 'ENXOVAL']
}
